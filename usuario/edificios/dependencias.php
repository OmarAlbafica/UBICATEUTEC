                                ...
                                while($row2 = mysqli_fetch_array($result2)){
                                    echo "<tr>";
                                        ...
                                        /*echo "<td>";
                                            ...
                                            echo "<a href='readlugares.php?id=". $row2['idsitio'] ."' title='Ver sitio' data-toggle='tooltip'><i class='material-icons'>visibility</i></a>";
                                            echo "<a href='updatelugares.php?id=". $row2['idsitio'] ."' title='Modificar sitio' data-toggle='tooltip'><i class='material-icons'>update</i></a>";
                                            echo "<a href='deletelugares.php?id=". $row2['idsitio'] ."' title='Borrar sitio' data-toggle='tooltip'><i class='material-icons'>delete_forever</i></a>";
                                        echo "</td>";*/
                                    echo "</tr>";
