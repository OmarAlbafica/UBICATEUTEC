<?php 
	...
	function ModificarUSer($nom, $ape, $dir, $tel, $correo, $user, $pass, $estado, $tipo, $id_usu){
		...
		$sentencia = "UPDATE usuario SET nombre='".$nom."', apellido='".$ape."', direccion='".$dir."', telefono='".$tel."', correo='".$correo."', user='".$user."', pass='".$pass."', estado='".$estado."', tipo='".$tipo."', fecha_creacion=NOW() WHERE idusurario= '".$id_usu."'";
