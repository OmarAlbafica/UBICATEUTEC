 <nav style="top: 0; margin-bottom: 3%">
    <div class="nav-wrapper pink darken-4">
      <a href="cola.php" class="brand-logo"><i class="material-icons white-text text-darken-4">home</i>Inicio</a>
      <a href="#" data-target="mobile-demo" class="sidenav-trigger"><i class="material-icons white-text text-darken-4">menu</i></a>
        ...
        <li><a href="indexCrudUsrCola.php"><i class="material-icons right white-text text-darken-4">person</i>Usuarios</a></li>
  ...
  <ul class="sidenav pink darken-4  white-text text-darken-4" id="mobile-demo">
        <li ><a class="white-text text-darken-4" href="cola.php"><i class="material-icons Small  white-text text-darken-4">home</i>Inicio</a></li>
        <li><a class="white-text text-darken-4" href="indexCrudUsrCola.php"><i class="material-icons right white-text text-darken-4">person</i>Usuarios</a></li>
